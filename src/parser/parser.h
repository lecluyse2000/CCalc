...
class Parser {
   ...
   private:
    void empty_stack();
    std::optional<std::string> parse(const std::string_view infix_expression, std::string& prefix_expression);
    std::optional<std::string> clear_stack(std::string& prefix_expression);
